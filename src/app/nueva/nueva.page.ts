...
export class NuevaPage implements OnInit {
  ...
  provinceName: string = 'nueva_vizcaya'; // Firestore collection name (with underscore)
  ...
  generateNewFile() {
    ...
    this.router.navigate(['/add-nueva']);
  }
  ...
  async loadComparisonData(file: FileData): Promise<{
    ...
    return { monthAgo, threeMonthsAgo };
  }
  ...
  generateMainSheetData(file: FileData, comparisonData: any): any[][] {
    ...
    data.push([`Province: Nueva Vizcaya`]);
